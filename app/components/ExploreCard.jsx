...
import animationData from "../../public/animation_lmhn70z6.json"
...
const ExploreCard = ({id, imgUrl, title, index, active, handleClick}) => (
  ...
  >
    ...
    {active !== id ? (
      <h3 className="font-semibold sm:text-[26px] text-[18px] text-orange-400 bg-[#1B232E]
      p-3 rounded-full absolute z-0 lg:bottom-20 lg:rotate-[-90deg] 
      lg:origin-[0,0]">
        {title}
      </h3>
    ) : (
      ...
      rounded-b-[24px]">
        ...
        glassmorphism mb-[16px]`}>
          <Lottie animationData={animationData} className="w-full h-full object-contain"/>
        </div>
        <p className="font-normal text-[16px] leading-[20px] text-orange-400 uppercase">
          Inizia ora
        </p>
